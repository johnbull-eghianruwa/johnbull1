...
[Archive Posts](https://cyberchimps.com/responsive-addons-for-elementor/docs/archive-posts/) - Archive Posts widget, you can display posts dynamically based on the date or specific category visited by the user.

[Archive Product Description] - Archive Product Description fetches the product archive page description.

[Archive Products] - Archive Products is used to get the list of products on the WooCommerce product archive page.

[Archive Title](https://cyberchimps.com/responsive-addons-for-elementor/docs/archive-title/) - The Archive Title widget shows a dynamic title based on the archive period viewed by the user.
...
[Author Box](https://cyberchimps.com/responsive-addons-for-elementor/docs/author-box/) - Author Box is a single post widget that dynamically displays the respective posts author.
...
[Featured Image](https://cyberchimps.com/responsive-addons-for-elementor/docs/featured-image/) -Featured Image widget lets you add the featured image of that particular page/post within the content.
...
[Gravity Form Styler](https://cyberchimps.com/responsive-addons-for-elementor/docs/gravity-forms-styler/) - Gravity Forms Styler allows you to style your gravity form to make it more attractive to the end-user.
...
[Menu Cart](https://cyberchimps.com/responsive-addons-for-elementor/docs/menu-cart/) - Menu Cart widget allows you to display the cart icon on the website.
...
[Modal Popup](https://cyberchimps.com/responsive-addons-for-elementor/docs/modal-popup/) - Modal Popup widget allows you to create amazing lightweight Popups that are displayed on click of a button.
...
[Portfolio](https://cyberchimps.com/responsive-addons-for-elementor/docs/portfolio/) - Portfolio Widget allows you to display your posts, pages, and custom post types in an attractive, filterable grid.
...
[Post Comments](https://cyberchimps.com/responsive-addons-for-elementor/docs/post-comments/) - Post Comments widget is a Single Post Template widget that displays the total number of comments on a post along with a form to submit a comment.

[Post Content](https://cyberchimps.com/responsive-addons-for-elementor/docs/post-content/) -Post Content widget displays the content of the page/post it is set upon.

[Post Excerpt](https://cyberchimps.com/responsive-addons-for-elementor/docs/post-excerpt/) - Post Excerpt widgets displays the text inputted in the excerpt at the time of creating the post.

[Post Info](https://cyberchimps.com/responsive-addons-for-elementor/docs/post-info/) - Post Info widget will fetch the meta details of the page/post to be displayed on the screen.

[Post Navigation](https://cyberchimps.com/responsive-addons-for-elementor/docs/post-navigation/) - Post Navigation is a single post template widget that dynamically displays links to the previous and next post.

[Post Title](https://cyberchimps.com/responsive-addons-for-elementor/docs/post-title/) - Post Title widget allows you to display the title of the page/post it is set upon.
...
[Product Additional Information] - Product Additional Information lets you display product related information.
...
[Product Content] -Product Content is used to get the product content from WooCommerce products.

[Product Data Tabs] - Product Data Tabs gives you the data information for WooCommerce products.

[Product Images](https://cyberchimps.com/responsive-addons-for-elementor/product-image-widget/) - Product images widget lets you add the WooCommerce product image dynamically on archive pages.

[Product Meta] - Product Meta helps you insert product meta without writing any code.

[Product Price](https://cyberchimps.com/responsive-addons-for-elementor/product-price-widget/) - Customize the product price for WooCommerce products on archive pages.

[Product Ratings](https://cyberchimps.com/responsive-addons-for-elementor/product-rating-widget/) - Product rating widget lets you add the WooCommerce product rating by fetching it dynamically on archive pages.

[Product Related] -Product Related lets you add the related products easily.

[Product Short Description] - With Short Description widget, you can add the product short description for WooCommerce products.

[Product Stock](https://cyberchimps.com/responsive-addons-for-elementor/product-stock/) - Product stock widgets fetches the stock quantity on archive pages.

[Product Title](https://cyberchimps.com/responsive-addons-for-elementor/product-title-widget/) - Product title widget lets you add the WooCommerce product titles dynamically on archive pages.
...
[Site Logo](https://cyberchimps.com/responsive-addons-for-elementor/docs/site-logo/) - Site Logo is a dynamic widget that enables you to display your logo anywhere you choose to use the widget.
...
[Upsells] - Upsells lets you add product upsells easily on dynamic product pages.
...
= 1.1.0 - 13th April 2024 =
- Releasing 37 new widgets in the plugin.

= 1.0.0 - 26th March 2024 =
- Introducing Responsive Addons for Elementor plugin.
- New: RAE Audio Player
- New: RAE Call To Action
- New: RAE Content Switcher
- New: RAE Flip Box
- New: RAE Timeline
...
You can install the Responsive Addons for Elementor plugin using any of the following two methods:

**WordPress Admin Dashboard Installation**

To install the Responsive Addons for Elementor plugin manually from the WordPress admin dashboard:

1. Download the latest Responsive Addons for Elementor plugin.
...
To install the Responsive Addons for Elementor plugin via FTP:

1. Download Responsive Addons for Elementor plugin zip
2. Unzip the Responsive Addons for Elementor zip file
...
6. Upload Responsive Addons for Elementor unzipped folder from step 2
