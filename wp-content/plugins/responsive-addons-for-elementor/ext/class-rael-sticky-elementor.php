...
if ( ! class_exists( 'Rael_Sticky_Elementor' ) ) {
	...
	class Rael_Sticky_Elementor {
		...
		public function __construct() {
			...
			add_action( 'elementor/element/after_section_end', array( $this, 'add_section_sticky_controls' ), 10, 3 );
		 ...
		 */
		public function add_section_sticky_controls( $section, $section_id, $args ) {

			static $layout_sections = array( 'section_advanced' );
